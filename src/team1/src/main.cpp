...
void imageCallback(const sensor_msgs::ImageConstPtr &msg)
{
    ...
    try
    {
        ...
        // catch (...)
        // {
        //     ROS_ERROR("Could not update image");
        // }
        detect->update(cv_ptr->image);
...
int main(int argc, char **argv)
{
    ...
    cv::namedWindow("Threshold Shadow");
    cv::namedWindow("Morphological Image Merged");
    cv::namedWindow("Morphological Image BirdView");
